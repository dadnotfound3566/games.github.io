...
function draw() {
  ...
  if (mouseX >= width - 30 || mouseX <= 30 || mouseY >= height - 30 || mouseY <= 30 || (dist(middelpuntBolX, middelpuntBolY, mouseX, mouseY) <= 80 && mouseX >= middelpuntBolX) || (dist(middelpuntBolX, middelpuntBolY, mouseX, mouseY) <= 80 && mouseX <= middelpuntBolX)) {
    kleur = 'red';
  } 
