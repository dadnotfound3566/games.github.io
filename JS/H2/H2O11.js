...
function draw() { background('lavender');
nummer = frameCount % aantalBeeldjes; image(animatie[nummer],150,0,breedte,hoogte);
text("frameCount=" + frameCount,5,40); text("nummer=" + nummer,5,70);
}